...
static Range::EqualizerRange bandLevelRange = MAKE_RANGE(Equalizer, bandLevels,
                                        std::vector<Equalizer::BandLevel>{
                                            Equalizer::BandLevel({.index = 0, .levelMb = -15})},
                                        std::vector<Equalizer::BandLevel>{
                                            Equalizer::BandLevel({.index = MAX_NUM_BANDS - 1, .levelMb = 15})});
static Range::EqualizerRange bandFrequencyRange = MAKE_RANGE(Equalizer, bandFrequencies,
                                                        kBandFrequencies, kBandFrequencies);
static Range::EqualizerRange presetsRange = MAKE_RANGE(Equalizer, presets, kPresets, kPresets);
static Range::EqualizerRange centerFreqRange = MAKE_RANGE(Equalizer, centerFreqMh,
